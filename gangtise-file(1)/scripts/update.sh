...
if [[ ! -d "gangtise-file" ]]; then
  echo "错误: 在 ${ROOT_DIR} 下未找到 gangtise-file 目录"
  exit 1
fi

echo "开始备份 gangtise-file ..."

zip -r "gangtise-file.bak" "gangtise-file"
...
echo "从远程下载最新 gangtise-file.zip ..."

curl -L "https://open.gangtise.com/obsproxy/windowsx64/gangtise-file.zip" -o "${TMP_ZIP}"
